...
ALTER TYPE public.account_type OWNER TO luroblesf;
...
ADD CONSTRAINT fk_classification FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
